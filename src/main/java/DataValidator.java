...
public class DataValidator {
    ...
    public static boolean peselValidator(long peselGiven) { //sprawdza numer PESEL pod względem nieprawidłowych danych (niewłaściwe numery miesięcy, dni
        ...
        String peselGivenToString = Long.toString(peselGiven); //zamieniamy long na string aby potem string na intigera przekonwertowac bez zmiany wartosci na kod ASCI(JAK CHAR)
